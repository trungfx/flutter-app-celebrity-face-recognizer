                    ...
                    if (_celebrities != null)
                      ..._celebrities
                              ...
                              .map((index, celebrity) {
                                ...
                                double scaleX = imageWidth / _imageWidth!;
                                double scaleY = imageHeight / _imageHeight!;

                                double x =
                                    celebrity.facialArea.x.toDouble() * scaleX;
                                double y =
                                    celebrity.facialArea.y.toDouble() * scaleY;
                                double w =
                                    celebrity.facialArea.w.toDouble() * scaleX;
                                double h =
                                    celebrity.facialArea.h.toDouble() * scaleY;
              ...
              Expanded(
                child: ListView.builder(
                  ...
                  itemBuilder: (BuildContext context, int index) {
                    ...
                    double x =
                        _celebrities![index].facialArea.x.toDouble() * scaleX;
                    double y =
                        _celebrities![index].facialArea.y.toDouble() * scaleY;
                    double w =
                        _celebrities![index].facialArea.w.toDouble() * scaleX;
                    double h =
                        _celebrities![index].facialArea.h.toDouble() * scaleY;
                        ...
                        child: ClipRect(
                          ...
                          child: Align(
                            ...
                            child: Image.file(
                              _image!,
                              width:
                                  _celebrities![index].facialArea.w.toDouble(),
                              height:
                                  _celebrities![index].facialArea.h.toDouble(),
                              fit: BoxFit.cover,
                              alignment: Alignment(
                                _celebrities![index].facialArea.x.toDouble(),
                                _celebrities![index].facialArea.y.toDouble(),
                              ),
                            ),
                          ),
                        ),
